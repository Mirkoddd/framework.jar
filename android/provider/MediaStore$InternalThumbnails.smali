...
.method static getThumbnail(Landroid/content/ContentResolver;JJILandroid/graphics/BitmapFactory$Options;Landroid/net/Uri;Z)Landroid/graphics/Bitmap;
    ...
    monitor-enter v5
    :try_end_24
    .catchall {:try_start_e .. :try_end_24} :catchall_1ca
    ...
    throw v3
    :try_end_60
    .catchall {:try_start_5f .. :try_end_60} :catchall_1ca
    ...
    :try_end_66
    .catchall {:try_start_61 .. :try_end_66} :catchall_1ca
    ...
    :try_end_ac
    .catchall {:try_start_79 .. :try_end_ac} :catchall_1ca
    ...
    invoke-virtual/range {v3 .. v8}, Landroid/content/ContentResolver;->query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    :try_end_f2
    .catchall {:try_start_bb .. :try_end_f2} :catchall_1ca
    ...
    :try_end_10f
    .catchall {:try_start_102 .. :try_end_10f} :catchall_1ca
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_102 .. :try_end_10f} :catch_60
    ...
    monitor-enter v5
    :try_end_124
    .catchall {:try_start_121 .. :try_end_124} :catchall_1ca
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_121 .. :try_end_124} :catch_60
    ...
    monitor-exit v5
    :try_end_14e
    .catchall {:try_start_124 .. :try_end_14e} :catchall_1c7
    ...
    invoke-interface {v12}, Landroid/database/Cursor;->moveToFirst()Z
    :try_end_1b7
    .catchall {:try_start_150 .. :try_end_1b7} :catchall_1ca
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_150 .. :try_end_1b7} :catch_60
    ...
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_1c9 .. :try_end_1ca} :catch_60
    ...
    :try_end_214
    .catchall {:try_start_1db .. :try_end_214} :catchall_1ca
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_1db .. :try_end_214} :catch_60
    ...
    :try_end_226
    .catchall {:try_start_221 .. :try_end_226} :catchall_1ca
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_221 .. :try_end_226} :catch_60
