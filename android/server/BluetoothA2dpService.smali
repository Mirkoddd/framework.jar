...
.method private declared-synchronized onSinkPropertyChanged(Ljava/lang/String;[Ljava/lang/String;)V
    ...
    const-string v7, " contentProtectionPending: "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    sget-boolean v7, Landroid/server/BluetoothA2dpService;->contentProtectionPending:Z

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v6

    const-string v7, " contentProtectionRequired: "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    sget-boolean v7, Landroid/server/BluetoothA2dpService;->contentProtectionRequired:Z
    ...
    :try_end_d5
    .catchall {:try_start_24 .. :try_end_d5} :catchall_21
...
.method public declared-synchronized connectSinkInternal(Landroid/bluetooth/BluetoothDevice;)Z
    ...
    invoke-virtual {v2}, Landroid/server/BluetoothService;->isEnabled()Z
    :try_end_a
    .catchall {:try_start_5 .. :try_end_a} :catchall_72
    ...
    :try_end_6a
    .catchall {:try_start_12 .. :try_end_6a} :catchall_72
...
.method public declared-synchronized isA2dpPlaying(Landroid/bluetooth/BluetoothDevice;)Z
    ...
    .line 268
    const-string/jumbo v0, "isA2dpPlaying()"
...
.method public declared-synchronized resumeSink(Landroid/bluetooth/BluetoothDevice;)Z
    ...
    iget-object v3, p0, Landroid/server/BluetoothA2dpService;->mAudioDevices:Ljava/util/HashMap;
    :try_end_28
    .catchall {:try_start_2 .. :try_end_28} :catchall_5b
    ...
    :try_end_59
    .catchall {:try_start_2c .. :try_end_59} :catchall_5b
...
.method public declared-synchronized suspendSink(Landroid/bluetooth/BluetoothDevice;)Z
    ...
    iget-object v3, p0, Landroid/server/BluetoothA2dpService;->mAudioDevices:Ljava/util/HashMap;
    :try_end_28
    .catchall {:try_start_2 .. :try_end_28} :catchall_5a
    ...
    invoke-direct {p0, v2}, Landroid/server/BluetoothA2dpService;->checkSinkSuspendState(I)Z
    :try_end_58
    .catchall {:try_start_2c .. :try_end_58} :catchall_5a
